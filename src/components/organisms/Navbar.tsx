...
function Navbar() {
   ...
   return (
      <Animate dir="down" useObserver={false} initiallyVisible={true} className="sticky top-0 left-0 z-20 h-14 w-full border-b border-gray-200 bg-gray-50 px-6 md:h-16 2xl:px-0">
   ...
   return (
      <Sheet
         ...
         <SheetTrigger className="p-0 lg:hidden">
            <Hamburger toggled={isOpen} onToggle={onOpen} direction="right" size={25} />
         </SheetTrigger>
         <SheetContent className="h-screen w-screen space-y-9" side="left">
            ...
            <div className="absolute top-0 right-0 -z-0 flex w-full justify-start">
               <Image src="/wavy.png" width={600} height={600} alt="wavy graphic" className="h-full w-full object-cover" unoptimized />
            </div>
         </SheetContent>
      </Sheet>
   )
